 ...
 * @version 2019.0421
 */
public class FinishView2 extends NewScreen implements Input.TextInputListener {
    /**
     ...
     */
    public FinishView2(JDCEGame g, GameScreen gameScreen, float time, boolean isItAWin, int levelNumber, int worldNumber) {
        super(g);
        this.time = time;
